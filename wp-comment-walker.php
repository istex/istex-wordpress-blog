<?php
class cyclone_blog_comment_walker extends Walker_Comment {
	...
	function start_el( &$output, $comment, $depth = 0, $args = array(), $id = 0 ) {
		...
		<li <?php comment_class(empty( $args['has_children'] ) ? '' :'parent') ?> id="comment-<?php echo absint( $comment->comment_ID ); ?>">
			...
			<?php 
			$avatar = get_avatar( $comment, 65, '', esc_attr__( 'Author gravatar' , 'cyclone-blog' ) ); 
			...
			<div class="comment-content">
				...
				<div class="edit_repy_links">
					...
					<a class="comment-edit-link btn btn-primary btn-sm" href="<?php echo esc_url( get_edit_comment_link( $comment->comment_ID ) ); ?>"><span class="comment-meta-item"><?php esc_html_e( 'Edit this comment', 'cyclone-blog' ); ?></span></a>
				...
				<?php if ( $comment->comment_approved == '0' ) : ?>
					<p class="comment-meta-item comment_awating"><?php esc_html_e( 'Your comment is awaiting moderation.' , 'cyclone-blog' ); ?></p>
				<?php endif; ?>
